...
import { LayoutsList, Login, Root, SetupPassword, UsersAdd, UsersList, UserDetailsView, ProfileView, LayoutsDetails } from "../views";
...
export const router = createBrowserRouter([
  ...
  {
    path: ROUTE_PATHS.LayoutsDetails,
    element: (
      <ProtectedRoute>
        <MainTemplate title="sc.fe.views.layoutsDetails.title">
          <LayoutsDetails />
        </MainTemplate>
      </ProtectedRoute>
    ),
